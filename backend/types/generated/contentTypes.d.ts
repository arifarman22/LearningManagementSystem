...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Published blog posts visible to all users';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'LMS courses created by instructors';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiLessonProgressLessonProgress
  ...
  info: {
    description: 'Tracks which lessons a student has completed';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual lessons belonging to a course';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiOptionOption extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An answer option for a quiz question';
    displayName: 'Option';
    pluralName: 'options';
    singularName: 'option';
  };
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A question belonging to a quiz';
...
export interface ApiQuizResultQuizResult extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A student's result for a quiz attempt";
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Quiz associated with a course';
    displayName: 'Quiz';
    pluralName: 'quizzes';
    singularName: 'quiz';
  };
