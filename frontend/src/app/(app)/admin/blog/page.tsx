...
export default function AdminBlogPage() {
  const { posts, loading, reload } = useAllBlogPosts();
      ...
      <Table>
        ...
        {loading ? (
          ...
          <TableEmpty
            ...
            title={search || statusFilter !== 'all' ? 'No posts match your filters' : 'No posts yet'}
          />
        ) : (
          <TableBody>
            {filtered.map((post) => (
              <TableRow key={post.documentId} className="hover:bg-neutral-50">
                ...
                <TableCell className="text-neutral-600">
                  {post.author?.username ?? <span className="text-neutral-300 italic">Unknown</span>}
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <div className="flex items-center justify-end gap-1">
                    <Button
                      ...
                      loading={actionLoading === post.documentId}
                    ...
                    <Button variant="ghost" size="xs" asChild>
                      <Link href={`/content/blog/${post.documentId}/edit`} className="no-underline" title="Edit">
                        <Edit3 size={14} />
                      </Link>
                    </Button>
                    <Button
