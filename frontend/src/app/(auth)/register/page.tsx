...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight, Sparkles, Shield, Users, Zap, CheckCircle } from 'lucide-react';
        ...
        {[0, 1, 2, 3].map((i) => (
          <div
            ...
            className={`h-1 flex-1 rounded-full transition-all duration-300 ${
              i < strength ? colors[strength - 1] : 'bg-neutral-200 dark:bg-neutral-700'
            }`}
          />
        ))}
      </div>
      <p className={`text-xs font-medium ${textColors[strength - 1] || 'text-neutral-400'}`}>
        {strength > 0 ? `${labels[strength - 1]} password` : 'Enter a password'}
      </p>
    </div>
  );
}
...
function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(defaultRouteForRole(user?.role?.type));
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} noValidate className="relative space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <User className="pointer-events-none absolute left-3.5 top-3.5 h-4 w-4 text-neutral-400 group-focus-within:text-brand-500 transition-colors" />
                <input
                  type="text"
                  placeholder="johndoe"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm pl-10 pr-4 py-3 text-sm text-neutral-900 dark:text-white placeholder:text-neutral-400 dark:placeholder:text-neutral-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 hover:border-neutral-300 dark:hover:border-neutral-600 ${errors.email && touched.email ? 'border-red-400 dark:border-red-500' : 'border-neutral-200 dark:border-neutral-700'}`}
                  autoComplete="email"
                  required
                />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={`w-full rounded-xl border bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm pl-10 pr-10 py-3 text-sm text-neutral-900 dark:text-white placeholder:text-neutral-400 dark:placeholder:text-neutral-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500 hover:border-neutral-300 dark:hover:border-neutral-600 ${errors.confirm && touched.confirm ? 'border-red-400 dark:border-red-500' : fields.confirm && fields.confirm === fields.password && fields.password.length >= 8 ? 'border-green-400 dark:border-green-500' : 'border-neutral-200 dark:border-neutral-700'}`}
                  autoComplete="new-password"
                  required
                />
                <button
                ...
                {fields.confirm && fields.confirm === fields.password && fields.password.length >= 8 && (
                  <CheckCircle className="pointer-events-none absolute right-10 top-3.5 h-4 w-4 text-green-500" />
                )}
              </div>
